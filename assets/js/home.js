...
debugger
  ...
  $('#btn-send-wish').on('tap', function(e) {
    ...
    var arrMg = ["fuck", "tmd", "他妈的","鸟","尿","睾丸","阴","死","屎","靠","鬼","龟","骂","痴","操","屁","臀","奶","乳房","乳","日你妈","rnm","cnm","TMD","RNM","CNM","Cnm","Rnm","孙子","狗","猪八戒","厕所","wc","WC","Wc","wC","哈皮","bi","你妹","妹","干","娘","牛逼","逼","瓜婆娘","去你妈的","老母","买","pi","p","狗日的","SB","sb","sB","Sb","道","傻","煞笔","儿子","儿","AV","黄片","黄","色","咪咪","瓜娃子","cao","草","球"];
