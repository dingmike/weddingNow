...
debugger
  ...
  $('#btn-send-wish').on('tap', function(e) {
    ...
    var arrMg = ["fuck", "tmd", "他妈的", "死","屎","靠","鬼","龟","骂","痴","操","屁","臀","奶","乳房","乳","日你妈","rnm","cnm","TMD","RNM","CNM","Cnm","Rnm","孙子","狗","猪八戒","哈皮","bi","牛逼","逼","瓜婆娘","去你妈的","老母","买","pi","p","狗日的","SB","sb","sB","Sb","傻","煞笔","儿子","儿","AV","黄片","黄","色","咪咪","cao","草","球"];
